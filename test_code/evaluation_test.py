...
import torchvision
from evaluation.degradation import Degradation
...
def main():
    ...
    res_single = evaluator.evaluate(heatmap,preprocessed_img.squeeze().to(device), pred_index)
    print(res_single)
    ...
    #degradation=Degradation(model=model,target=None,tile_size=(224,224))
    #eval_result=Degradation.evaluate(degradation,heatmap,image)    
    #print(eval_result)
