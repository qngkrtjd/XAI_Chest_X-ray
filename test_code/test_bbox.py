...
with open(csv_file, 'r') as f:
    ...
    if(is_vit):
        result_file = open("result_vit_SG.txt","w")
    else:
        result_file = open("result_densenet_SG.txt", "w")
